...
const Self = class ChannelPicker extends ColorElement {
	...
	static shadowTemplate = `
		<space-picker part="space-picker" exportparts="picker:space-select" id="space_picker"></space-picker>
	...
	connectedCallback () {
		...
		this._el.channels.addEventListener("change", this, {capture: true});
	}
	...
	disconnectedCallback () {
		...
		this._el.channels.removeEventListener("change", this, {capture: true});
	}
